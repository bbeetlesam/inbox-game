...
mail.draw = function()
    -- inner rectangle
    utils.bevelRect(mail.innerBevel.startX, mail.innerBevel.startY, mail.innerBevel.w, mail.innerBevel.h, 3, const.color.SILVER_TASKBAR, const.color.SILVER_BEVEL, const.color.WHITE)
    -- upper buttons
    love.graphics.setFont(mail.font.header)
    utils.bevelRect(mail.innerBevel.startX, mail.upperButton.startY, 100, 35, 3, const.color.SILVER_TASKBAR, const.color.SILVER_BEVEL, const.color.WHITE, {1, 1, 0, 1})
    utils.bevelRect(mail.innerBevel.startX + 100, mail.upperButton.startY, 80, 35, 3, const.color.SILVER_TASKBAR, const.color.SILVER_BEVEL, const.color.WHITE, {1, 1, 0, 1})
    utils.bevelRect(mail.innerBevel.startX + 100 + 80, mail.upperButton.startY, 110, 35, 3, const.color.SILVER_TASKBAR, const.color.SILVER_BEVEL, const.color.WHITE, {1, 1, 0, 1})
    utils.bevelRect(mail.innerBevel.startX + 100 + 80 + 110, mail.upperButton.startY, 70, 35, 3, const.color.SILVER_TASKBAR, const.color.SILVER_BEVEL, const.color.WHITE, {1, 1, 0, 1})
    ...
    -- 3 lower buttons
    utils.bevelRect(mail.lowerButton.startX, mail.lowerButton.startY, mail.lowerButton.w, mail.lowerButton.h, 3, const.color.SILVER_TASKBAR, const.color.SILVER_BEVEL, const.color.WHITE)
    utils.bevelRect(mail.lowerButton.startX + (mail.lowerButton.w+mail.lowerButton.gapX), mail.lowerButton.startY, mail.lowerButton.w, mail.lowerButton.h, 3, const.color.SILVER_TASKBAR, const.color.SILVER_BEVEL, const.color.WHITE)
    utils.bevelRect(mail.lowerButton.startX + (mail.lowerButton.w+mail.lowerButton.gapX)*2, mail.lowerButton.startY, mail.lowerButton.w, mail.lowerButton.h, 3, const.color.SILVER_TASKBAR, const.color.SILVER_BEVEL, const.color.WHITE)
    love.graphics.setColor(const.color.BLACK)
